...
In future:  
  * An argument will be implemented to control the probability that the values under each variable occur.  In this way it will be possible to tune the output in line with your facility's numbers (eg. no missing data).
